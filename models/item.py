...
class Arma(Item):
    ...
    def __init__(self, nome: str, descricao: str, dano_min: int, dano_max: int, ativo: bool = False):
...
class Magico(Item):
    ...
    def __init__(self, nome, descricao, descricao_ataque: str, atributo, valor, custo, ativo=False):
